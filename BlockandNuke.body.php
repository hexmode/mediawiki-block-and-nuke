...
class SpecialBlock_Nuke extends SpecialPage {
	...
	function execute( $par ){
		...
		if( $posted ) {
		 	...
		 	if($user){ 
		 		$wgOut->addHTML("To block the selected users and delete all their contributions click the button below.");   
	...
	function whiteList() {
		...
		$whitelist_file = ("http://thepetwiki.com/extensions/BlockandNuke/whitelist.txt");
